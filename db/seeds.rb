...
User.create(role: 1, username: "KeinerHA", name: "Harold Keiner", email: "keinerapiary@gmail.com", password: "1234")
User.create(role: 1, username: "test 2", name: "Suzanne Test", email: "test@btbm.com", password: "1234")


User.create(role: 0, username: "shopper", name: "Not Vendor", email: "test@test.com", password: "1234")
